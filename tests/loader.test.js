...
const SPACESPEAK_SHIPPING = [
  ...
  { dialect: 'startrek',     expected_tone_cap: 0.20 },
  { dialect: 'starwars',     expected_tone_cap: 0.12 },
  { dialect: 'doctorwho',          expected_tone_cap: 0.25 },
  { dialect: 'firefly',      expected_tone_cap: 0.09 },
  { dialect: 'galactica',    expected_tone_cap: 0.10 },
  { dialect: 'stargate',     expected_tone_cap: 0.13 },
];
...
const BARDSPEAK_SHIPPING = [
  ...
  { dialect: 'viking',  expected_tone_cap: 0.15 },
...
const STYLESPEAK_SHIPPING = [
  ...
  { dialect: 'steampunk',    expected_tone_cap: 0.19 },
